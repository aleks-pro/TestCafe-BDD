...
function createTestFile() {
    fs.writeFileSync('test.js',
        'import errorHandling from "./e2e/support/errorHandling.js";\n' +
        'import testControllerHolder from "./e2e/support/testControllerHolder.js";\n\n' +
...
function runTest(iteration, browser) {
    createTestCafe('localhost', 1338 + iteration, 1339 + iteration)
        .then(function(tc) {
            ...
            runner.useProxy('proxy-dev.discoverfinancial.com:8080');
            return runner
                .src('./test.js')
